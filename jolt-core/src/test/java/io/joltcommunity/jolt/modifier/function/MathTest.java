...
import static io.joltcommunity.jolt.modifier.function.Objects.toNumber;
...
public class MathTest extends AbstractTester {
    ...
    public Iterator<Object[]> getTestCases() {
        ...
        testCases.add(new Object[]{"mul-emptyleft-element", MUL_OF, Arrays.asList(10L, null), Optional.empty()});
        testCases.add(new Object[]{"mul-emptyright-element", MUL_OF, Arrays.asList(null, 10L), Optional.empty()});
