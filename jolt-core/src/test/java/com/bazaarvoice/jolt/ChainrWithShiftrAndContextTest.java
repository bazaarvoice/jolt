...
public class ChainrWithShiftrAndContextTest {

    @DataProvider
    public Iterator<Object[]> getTests() throws IOException {

        String testPath = "/json/chainr/context/spec_shiftr_and_context.json";
        Map<String, Object> testSuite = JsonUtils.jsonToMap( ChainrWithShiftrAndContextTest.class.getResourceAsStream( testPath ) );
    ...
    public void successCase( String testCaseName, Object spec, Object input, Map<String,Object> context, Object expected ) throws IOException {
        ...
        Assert.assertEquals( unit.getContextualTransforms().size(), 1 );
